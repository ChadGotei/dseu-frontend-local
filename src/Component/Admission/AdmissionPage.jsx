  ...
  return (
    <main className="flex flex-col mt-8 md:mt-12 md:mb-10 mb-16 justify-center items-center w-full max-w-3xl gap-4 sm:gap-6 md:gap-8 mx-auto">
      ...
      <div className="w-full p-5 space-y-4">
        {portals.map(({ id, text, bolded, link }) => (
          <div
            key={id}
          ...
          >
            <div className="flex justify-between items-center">
              ...
              <a
                ...
                className="ml-4 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-2 rounded-md transition-colors duration-200"
              >
                Visit Portal
              </a>
            </div>
