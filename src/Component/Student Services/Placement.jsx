  ...
  return (
    <div className="w-full my-10 mt-10 px-4 md:px-0">
      ...
      <div className="flex justify-center mt-4 space-x-1 md:space-x-2">
        {Array.from({
          length: Math.max(1, images.length - slidesPerView + 1),
        }).map((_, index) => (
          <button
            key={index}
...
const Placement = () => {
  ...
  return (
    <div className="w-4/5 mx-auto my-10 text-gray-800">
      ...
      <div className="mb-12">
        ...
        <div className="mt-4">
          <p className="text-gray-600 leading-relaxed text-justify mb-4">
            Our placement policy outlines the guidelines and procedures for
            student placements, ensuring a transparent and fair process. Access
            the detailed policy document below.
          </p>
          <a
      ...
      <div>
        <h2 className="text-2xl md:text-3xl font-bold">Placement Contact Details</h2>
