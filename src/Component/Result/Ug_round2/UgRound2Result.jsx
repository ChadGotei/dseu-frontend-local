...
import { getUgRound2Result } from "../../../utils/resultservices";
import { showErrorToast, showSuccessToast } from "../../../utils/toasts";
import dseulogo from "../../../assets/dseulogofullnew.svg";

import Tooltip from "../../Reusable/Tooltip";

const UgRound2Result = () => {
    ...
    const { mutate } = useMutation({
        mutationFn: getUgRound2Result,
        onSuccess: (data) => {
            showSuccessToast("Result fetched successfully");
            setResult(data);
            navigate("/admission/result/ug2/show");
        },
        onError: (error) => {
        ...
        <div className="pt-10 flex items-center justify-center bg-gray-100 p-4 flex-col gap-10 pb-20">
            ...
            <div className="flex gap-6 mb-10">
                <button
                    ...
                    onClick={() => navigate("/admission/result/ug")}
                >
                    Round 1
                </button>
                <button
            ...
            <div className="flex flex-col items-center justify-center gap-7">
                ...
                <h2 className="text-2xl sm:text-2xl md:text-3xl font-extrabold text-center text-blue-700 font-sans mt-5">
                    DSEU <span className="capitalize">UG Round 2</span> Seat Allocation
