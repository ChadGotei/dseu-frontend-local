...
const ShowDiplomaRound2 = () => {
    ...
    useEffect(() => {
        ...
        if (!result) {
            ...
            navigate("/admission/result/diploma/round2");
        }
    }, [result, navigate]);
    ...
    const statusMutation = useMutation({
        mutationFn: ({ id, status }) => changeDiplomaRound2Status(id, status),
        onSuccess: (data) => {
                    ...
                    {student.status === "pending" &&
                        <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 p-4 rounded-lg text-center max-w-xl">
                            ...
                            <p className="text-justify">
                                The seat confirmation window for Diploma round 2 admissions is now closed.
...
export default ShowDiplomaRound2