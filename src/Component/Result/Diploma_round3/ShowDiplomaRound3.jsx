...
import useResultStore from "../../../store/diplomaRound3Store";
import { changeDiplomaRound3Status } from "../../../utils/resultservices";
import { showErrorToast, showSuccessToast } from "../../../utils/toasts";
import { getCategoryFullname, getStatusFromAction } from "../../../utils/helper";
import { useNavigate } from "react-router-dom";

const ShowDiplomaRound3 = () => {
    ...
    useEffect(() => {
        ...
        if (!result) {
            ...
            navigate("/admission/result/diploma/round3");
        }
    }, [result, navigate]);
    ...
    const statusMutation = useMutation({
        mutationFn: ({ id, status }) => changeDiplomaRound3Status(id, status),
        onSuccess: (data) => {
                    ...
                    {student.status === "pending" &&
                        <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 p-4 rounded-lg text-center max-w-xl">
                            ...
                            <p className="text-justify">
                                The seat confirmation window for Diploma round 3 admissions is now closed.
...
export default ShowDiplomaRound3