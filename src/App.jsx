...
const AcademicRegulation = lazy(() =>
  import("./Component/AcademicRegulation/page")
);
const AcademicCollabration = lazy(() =>
  import("./Component/Academics/AcademicCollaboration")
);
const AcademicAdministration = lazy(() =>
  import("./Component/Academics/AcademicAdministration")
);
...
const AdmissionPage = lazy(() =>
  import("./Component/Admission/AdmissionPage.jsx")
);
const IB = lazy(() => import("./Component/Admission/IB.jsx"));
const AdmissionGuidelines = lazy(() =>
  import("./Component/Admission/AdmissionGuidelines")
);
const FeeRefundPolicy = lazy(() =>
  import("./Component/Admission/FeeRefundPolicy")
);
const ProcessAndGuidelines = lazy(() =>
  import("./Component/Admission/ProcessAndGuidelines")
);

// Administrative
const AdministrationTemp = lazy(() =>
  import("./Component/Administration/page")
);
const ChancellorPage = lazy(() =>
  import("./Component/Administration/ChancellorPage")
);
const ViceChancellorPage = lazy(() =>
  import("./Component/Body/ViceChancellorPage")
);
...
const RecruitmentRules = lazy(() =>
  import("./Component/Administration/RecruitmentRules")
);
...
const AntiRagging = lazy(() =>
  import("./Component/Student Services/AntiRagging")
);
const Scholarship = lazy(() =>
  import("./Component/Student Services/Scholarship")
);
const EqualOpportunity = lazy(() =>
  import("./Component/Student Services/EqualOpportunity")
);
...
const ArchivedJobPortal = lazy(() =>
  import("./Component/Administration/ArchivedJobPortal")
);

// Enterpreneurship
const Entrepreneurship = lazy(() =>
  import("./Component/NavItems/Entrepreneurship")
);
        ...
        <Routes>
          <Route element={<UserLayout />}>
            ...
            <Route
              ...
              element={<AcademicAdministration />}
            />
            ...
            <Route
              path="/recruitment/archive/:category"
              element={<ArchivedJobPortal />}
            />
            ...
            <Route
              path="/amenities/Equal-Opportunity"
